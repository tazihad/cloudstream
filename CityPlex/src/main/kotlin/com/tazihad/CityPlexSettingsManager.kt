...
// Reuses the same SharedPreferences file and keys as DhakaFlix so the user's
// configured TMDB API key carries over between plugins automatically.
object CityPlexSettingsManager {
    ...
    private const val TAG = "CityPlexSettings"

...
class CityPlexSettings : BottomSheetDialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val tmdbToggle = CheckBox(context).apply {
            ...
            isChecked = CityPlexSettingsManager.isTmdbEnabled()
        ...
        val input = EditText(context).apply {
            ...
            setText(CityPlexSettingsManager.getApiKey() ?: "")
        ...
        return AlertDialog.Builder(context)
            .setTitle("CityPlex Settings")
            .setView(layout)
            .setPositiveButton("Save") { _, _ ->
                val tmdbEnabled = tmdbToggle.isChecked
                val apiKey = input.text.toString().trim()

                if (!CityPlexSettingsManager.setTmdbEnabled(tmdbEnabled)) {
                ...
                if (tmdbEnabled) {
                    when {
                        ...
                        !apiKey.matches(Regex("^[a-zA-Z0-9]+$")) -> {
                            ...
                            if (CityPlexSettingsManager.setApiKey(apiKey)) {
                    ...
                    if (apiKey.isNotEmpty()) {
                        CityPlexSettingsManager.setApiKey(apiKey)
                    }
    ...
    companion object {
        fun newInstance(): CityPlexSettings {
            return CityPlexSettings()
        }
    }
}
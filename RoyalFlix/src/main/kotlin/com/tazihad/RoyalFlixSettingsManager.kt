...
// Reuses the same SharedPreferences file and keys as DhakaFlix/CityPlex/CTG Hall
// so the user's configured TMDB API key carries over between plugins automatically.
object RoyalFlixSettingsManager {
    ...
    private const val TAG = "RoyalFlixSettings"

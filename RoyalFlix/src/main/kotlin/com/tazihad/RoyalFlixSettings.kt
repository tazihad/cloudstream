...
class RoyalFlixSettings : BottomSheetDialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val tmdbToggle = CheckBox(context).apply {
            ...
            isChecked = RoyalFlixSettingsManager.isTmdbEnabled()
        ...
        val input = EditText(context).apply {
            ...
            setText(RoyalFlixSettingsManager.getApiKey() ?: "")
        ...
        return AlertDialog.Builder(context)
            .setTitle("RoyalFlix Settings")
            .setView(layout)
            .setPositiveButton("Save") { _, _ ->
                val tmdbEnabled = tmdbToggle.isChecked
                val apiKey = input.text.toString().trim()

                if (!RoyalFlixSettingsManager.setTmdbEnabled(tmdbEnabled)) {
                ...
                if (tmdbEnabled) {
                    when {
                        ...
                        !apiKey.matches(Regex("^[a-zA-Z0-9]+$")) -> {
                            ...
                            if (RoyalFlixSettingsManager.setApiKey(apiKey)) {
                    ...
                    if (apiKey.isNotEmpty()) {
                        RoyalFlixSettingsManager.setApiKey(apiKey)
                    }
    ...
    companion object {
        fun newInstance(): RoyalFlixSettings {
            return RoyalFlixSettings()
        }
    }
}